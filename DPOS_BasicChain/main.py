...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
        ...
        <div class="row">
           ...
           <h1>BasicChain Blockchain</h1>
        <a class="btn btn-primary" href="http://127.0.0.1:5000/mine" role="button">Mine</a>
        <a class="btn btn-success" href="http://127.0.0.1:5000/nodes/add" role="button">Add New Node</a>
        <a class="btn btn-success" href="http://127.0.0.1:5000/chain" role="button">Show Blockchain</a>
